...
public class deonisMenu extends AppCompatActivity {
    private ImageButton infoButtonD;
    private Button backButtonD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deonis_menu);

        infoButtonD = (ImageButton) findViewById(R.id.infoButtonD);
        infoButtonD.setOnClickListener(new View.OnClickListener(){
            @Override
        ...
        backButtonD = (Button) findViewById(R.id.backButtonD);
